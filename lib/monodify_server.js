...
MonodifyServer.prototype.handleConnection = function(socket) {
	...
	socket.on('queueTrack', this.queueTrack.bind(this));
	socket.on('queueNext', this.queueNext.bind(this));
};
...
MonodifyServer.prototype.queueTrack = function(spotifyUrl) {
	this.queue.push(spotifyUrl);
};

MonodifyServer.prototype.queueNext = function(spotifyUrl) {
	this.queue.unshift(spotifyUrl);
};
